...
object Sidebar : BorderPane() {
    ...
    init {
        ...
        if (SystemInfo.isMacOS && SystemInfo.isMacFullWindowContentSupported) {
            ...
            dev.shota.decompiler.old.WindowOld.addComponentListener(object : ComponentAdapter() {
                override fun componentResized(e: ComponentEvent?) {
                    Platform.runLater {
                        top = if (dev.shota.decompiler.old.WindowOld.height > GraphicsEnvironment.getLocalGraphicsEnvironment().maximumWindowBounds.height) null else space
                    }
                }
            })
        }
